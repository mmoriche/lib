function [xf varargout] = airfoil_4r(m,p,t, c, dx, varargin)
% @author M.Moriche
%
...
% initial values
[xl xu yl yu]=geometry.naca.naca_4r(m,p,t,c,c,'alpha',alfa,'zerothickness',zerothickness);
xnow = [xu,yu];
i=1;
x0(i,:) = [xu, yu];
i = i+1;
...
while cdone<c
    ...
    while ~flag
       ...
       x1=cdone+dxi;
       [xl xu yl yu]=geometry.naca.naca_4r(m,p,t,c-x1,c,'alpha',alfa,'zerothickness',zerothickness);
       xnext_1 = [xu, yu];

       x2=cdone+dxi/2;
       [xl xu yl yu]=geometry.naca.naca_4r(m,p,t,c-x2,c,'alpha',alfa,'zerothickness',zerothickness);
       xnext_2 = [xu, yu];
